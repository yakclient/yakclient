...
import dev.extframework.components.extloader.EXT_LOADER_ARTIFACT
import dev.extframework.components.extloader.EXT_LOADER_GROUP
import dev.extframework.components.extloader.EXT_LOADER_VERSION
...
import dev.extframework.components.extloader.preloadedMavenArchives
...
internal fun isInHierarchy(
    ...
    return preloadedMavenArchives.any { descriptor.sameArtifact(it) }
}
